...
public class Library {
	...
	public void closeApp(String appName) {
		try {
			...
			params3.put("name", appName);
			Object result3 = driver.executeScript("mobile:application:close", params3);
		} catch (Exception ex) {
	...
	public void installApp(String repoKey, boolean instrument) {
		Map<String, Object> params1 = new HashMap<>();
		params1.put("file", repoKey);
		if (instrument) {
			params1.put("instrument", "instrument");

		} else {
			params1.put("instrument", "noinstrument");
		}
