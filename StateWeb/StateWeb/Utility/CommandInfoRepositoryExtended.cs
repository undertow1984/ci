...
namespace OpenQA.Selenium.Remote
{
    ...
    /// </summary>
    public sealed class CommandInfoRepositoryExtended
    {
        ...
        private static volatile CommandInfoRepositoryExtended collectionInstance;
        ...
        /// </summary>
        private CommandInfoRepositoryExtended()
        {
        ...
        /// </summary>
        public static CommandInfoRepositoryExtended Instance
        {
            get
            {
                ...
                if (collectionInstance == null)
                {
                    lock (LockObject)
                    {
                        if (collectionInstance == null)
                        {
                            collectionInstance = new CommandInfoRepositoryExtended();
                        }
                    }
                }
        ...
        private void InitializeCommandDictionary()
        {
            ...
            this.commandDictionary.Add("setContext", new CommandInfo(CommandInfo.PostCommand, "/session/{sessionId}/context"));
            this.commandDictionary.Add("getContext", new CommandInfo(CommandInfo.GetCommand, "/session/{sessionId}/context"));
            this.commandDictionary.Add("contexts", new CommandInfo(CommandInfo.GetCommand, "/session/{sessionId}/contexts"));
        }
        #endregion
    }
}
